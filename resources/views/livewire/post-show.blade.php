<div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
    <article class="pt-5 pb-2 mx-auto bg-white border-2 border-b border-black rounded-t-lg max-w-none border-b-gray-300">
        ...
        <!-- Content -->
        <div class="px-4 py-4 space-y-2 font-normal text-gray-700 sm:px-6">
            @if ($post->photo)
        ...
        <footer class="px-4 pt-2 border-t border-gray-200 sm:px-6">
            <div class="flex items-center justify-between">
