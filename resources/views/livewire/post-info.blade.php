            ...
            <div class="py-4 space-y-2 font-normal text-gray-700">
                @if ($post->photo)
                    <img src="{{ asset('storage/' . $post->photo) }}"
                        class="object-cover w-full rounded-lg min-h-auto max-h-64 md:max-h-72" alt="" />
                @endif
                <p>{{ $post->barta }}</p>
            </div>
            ...
            <footer class="pt-2 border-t border-gray-200">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        <!-- Share Button -->
                        <!-- <button
type="button" class="flex items-center gap-2 p-2 -m-2 text-xs text-gray-600 rounded-full hover:text-gray-800">
