            ...
            <div class="space-y-2 py-4 font-normal text-gray-700">
                @if ($post->photo)
                    <img src="{{ asset('storage/' . $post->photo) }}"
                        class="min-h-auto max-h-64 w-full rounded-lg object-cover md:max-h-72" alt="" />
                @endif
                <p>{{ $post->barta }}</p>
            </div>
            ...
            <footer class="border-t border-gray-200 pt-2">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        <!-- Share Button -->
                        <!-- <button
type="button" class="-m-2 flex items-center gap-2 rounded-full p-2 text-xs text-gray-600 hover:text-gray-800">
