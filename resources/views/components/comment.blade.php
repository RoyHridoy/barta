            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div class="flex-shrink-0">
                        <img class="h-10 w-10 rounded-full object-cover" src="{{ $comment->author->avatar }}"
                                ...
                                @can('edit', $comment)
                                    ...
                                    @can('delete', $comment)
                                        <button id="user-menu-item-1"
                                            wire:click="deleteComment({{ $comment->id }}); open = false"
        ...
        <div class="py-4 font-normal text-gray-700">
            ...
            <div x-show="openEdit">
                <form method="POST">
                    @csrf
                    @method('PATCH')
                    <button type="button" class="right-0 float-right mb-1 rounded-md bg-red-500 px-2 text-white"
